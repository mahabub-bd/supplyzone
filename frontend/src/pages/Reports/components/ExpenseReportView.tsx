...
export default function ExpenseReportView() {
  ...
  const [fetchReport, { isLoading, isError }] = useLazyGetExpenseReportQuery();
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      toast.error(error?.data?.message || "Failed to generate expense report");
    }
  };
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Generate and view expense reports"
        className="mb-6"
      />
